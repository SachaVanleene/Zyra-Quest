...
public class Mage implements Ennemie {
	// ENNEMIE MAGE detecte l'aggro  mais ne bouge pas et n'envoie que des boules de feu
		...
		public int Hitbox_x = 28; //Caract√©ristique necessaiare a la construction de la Hitbox
		public int Hitbox_y = 37;
		private Hitbox_mage hitbox;
		public int px; // position 
		public int py;
		public int aggroX = 500;
		...
		private int nmort;
		public Mage (int spawnx,int spawny){
			this.nmort=1;
			this.animMort=true;
			this.px=spawnx;
			this.py=spawny;
			this.hitbox = new Hitbox_mage(px,py,Hitbox_x,Hitbox_y); //CENTRER SUR LAFFICHAGE /!\
			atk = new ArrayList<AttaqueDistance>();
			this.attaque=false;
			this.nattaque=0;
			this.image = new String("src/Mage/ImmobileInv.png");
		}
		...
		//System.out.println("AggroX: "+Math.abs((this.px-(px)))+" Aggro y"+Math.abs((this.py-(py))));
			if(this.attaque){
				if(this.Vanimfixe==this.Vanimcourante){
					...
					switch (nattaque){
						case 1:
							this.image = "src/Mage/Attaque2Inv.png";
							this.nattaque++;
							break;
						case 2 :
							this.image = "src/Mage/Attaque3Inv.png";
							this.nattaque++;
							break;
						case 3:
							this.image = "src/Mage/Attaque4Inv.png";
							this.nattaque++;
							break;
						case 4:
							this.image = "src/Mage/Attaque5Inv.png";
							this.nattaque++;
							break;
						case 5:
							this.image = "src/Mage/AttaquefinInv.png";
							if (this.atk.size() < 40) { //ATTRIBUT
								bdf = new AttaqueDistance(this.dommage,"src/Mage/Bouledefeu.png",this.px,this.py,px,py,4,4,8,8); // dernier parametre ceracrtÈristique hitbox , caractÈristique image
								this.atk.add(bdf);
							} 
							this.nattaque++;
							break;
						case 6:
							this.image = "src/Mage/ImmobileInv.png";
				...
				if (Math.abs((this.px-(px)))<aggroX && Math.abs((this.py-(py)))<this.aggroY){
					...
					this.attaque=true;
					this.nattaque++;
					this.image = "src/Mage/Attaque1Invisible.png"; //debut de l'attaque
				}
			}
		...
		if(this.animMort){
			if(this.Vanimfixe==this.Vanimcourante){
				...
				switch (nmort){
					case 1:
						this.nmort++;
						this.image="src/Mage/Mort1Inv.png";
					case 2:
						this.nmort++;
						this.image="src/Mage/Mort2Inv.png";
						break;
					case 3 :
						this.nmort++;
						this.image="src/Mage/Mort3Inv.png";
						break;
					case 4:
						this.nmort++;
						this.image="src/Mage/Mort4Inv.png";
						break;
					case 5:
						this.nmort++;
						this.image="src/Mage/Mort5Inv.png";
						this.animMort=false;
						break;
				}
			} else {
